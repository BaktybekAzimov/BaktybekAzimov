...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'auth.login': 'Войти',
    'auth.logout': 'Выйти',
    'auth.login_error': 'Ошибка входа. Проверьте email и пароль.',
    'auth.subtitle': 'Система учёта рейсов грузовиков',
    'auth.demo_access': 'Демо доступ',
    'auth.demo_admin': 'Администратор',
    'auth.demo_dispatcher': 'Диспетчер',
    'auth.demo_driver': 'Водитель',
    ...
    'validation.phone_invalid': 'Некорректный формат телефона',
    ...
    'driver_form.subtitle': 'Быстрое добавление нового рейса',
    'driver_form.success': 'Рейс успешно добавлен!',
    'driver_form.success_desc': 'Данные сохранены в системе.',
    'driver_form.driver': 'Водитель',
    'driver_form.select_driver': 'Выберите водителя',
    'driver_form.trip_date': 'Дата рейса',
    'driver_form.date_required': 'Дата обязательна',
    'driver_form.route': 'Маршрут',
    'driver_form.select_route': 'Выберите маршрут',
    'driver_form.revenue': 'Выручка',
    'driver_form.revenue_required': 'Выручка обязательна',
    'driver_form.revenue_positive': 'Выручка должна быть положительной',
    'driver_form.fuel_cost': 'Расход на топливо',
    'driver_form.fuel_required': 'Расход на топливо обязателен',
    'driver_form.cost_positive': 'Расход должен быть положительным',
    'driver_form.other_costs': 'Прочие расходы',
    'driver_form.other_costs_hint': 'Парковка, питание, и т.д.',
    'driver_form.your_payment': 'Ваша выплата (30%)',
    'driver_form.net_profit': 'Чистая прибыль:',
    'driver_form.total_costs': 'Всего расходы:',
    'driver_form.submit': 'Отправить рейс',
    'driver_form.footer': 'Заполните все поля для добавления рейса в систему',
    'driver_form.driver_not_found': 'Водитель не найден',
    'driver_form.no_vehicles': 'Нет доступных автомобилей',
    'driver_form.created_by_driver': 'Создано водителем через форму',
    'driver_form.save_error': 'Не удалось сохранить рейс',
    'driver_form.load_error': 'Не удалось загрузить данные',
  ...
  ky: {
    ...
    'notifications.unread': 'окулбаган',
    ...
    'auth.login': 'Кирүү',
    'auth.logout': 'Чыгуу',
    'auth.login_error': 'Кирүү катасы. Email жана сыр сөздү текшериңиз.',
    'auth.subtitle': 'Жүк ташуучу унааларды эсепке алуу системасы',
    'auth.demo_access': 'Демо кирүү',
    'auth.demo_admin': 'Администратор',
    'auth.demo_dispatcher': 'Диспетчер',
    'auth.demo_driver': 'Айдоочу',
    ...
    'validation.phone_invalid': 'Телефон форматы туура эмес',
    ...
    'driver_form.subtitle': 'Жаңы рейсти тез кошуу',
    'driver_form.success': 'Рейс ийгиликтүү кошулду!',
    'driver_form.success_desc': 'Маалыматтар системага сакталды.',
    'driver_form.driver': 'Айдоочу',
    'driver_form.select_driver': 'Айдоочуну тандаңыз',
    'driver_form.trip_date': 'Рейс күнү',
    'driver_form.date_required': 'Күнү милдеттүү',
    'driver_form.route': 'Маршрут',
    'driver_form.select_route': 'Маршрутту тандаңыз',
    'driver_form.revenue': 'Киреше',
    'driver_form.revenue_required': 'Киреше милдеттүү',
    'driver_form.revenue_positive': 'Киреше оң болушу керек',
    'driver_form.fuel_cost': 'Күйүүчү майга чыгым',
    'driver_form.fuel_required': 'Күйүүчү майга чыгым милдеттүү',
    'driver_form.cost_positive': 'Чыгым оң болушу керек',
    'driver_form.other_costs': 'Башка чыгымдар',
    'driver_form.other_costs_hint': 'Токтоочу жай, тамак-аш ж.б.',
    'driver_form.your_payment': 'Сиздин төлөмүңүз (30%)',
    'driver_form.net_profit': 'Таза пайда:',
    'driver_form.total_costs': 'Жалпы чыгымдар:',
    'driver_form.submit': 'Рейсти жөнөтүү',
    'driver_form.footer': 'Рейсти системага кошуу үчүн бардык талааларды толтуруңуз',
    'driver_form.driver_not_found': 'Айдоочу табылган жок',
    'driver_form.no_vehicles': 'Бош унаалар жок',
    'driver_form.created_by_driver': 'Айдоочу тарабынан форма аркылуу түзүлдү',
    'driver_form.save_error': 'Рейсти сактоо мүмкүн болбоду',
    'driver_form.load_error': 'Маалыматтарды жүктөө мүмкүн болбоду',
